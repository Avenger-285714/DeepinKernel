...
typedef struct V206DEV024 {
	...
	GLJ_EVENT               V206DEV064[V206API030 + 9];

	int                      V206DEV065;

	unsigned long           V206DEV066[MWV206INTR_GROUP];
	unsigned int            V206DEV067[V206API030 + 9];

	MemMgr                  V206DEV068[4];
	int                     V206DEV069;

	V206DEV012        V206DEV070[V206API030];
	int V206DEV071;
	int V206DEV072;
	int V206DEV073;
	int V206DEV074;
	...
	struct pm {
		...
		int V206DEV110[4];
		int V206DEV111[4];
		int V206DEV112[V206GLJ042];
		int V206DEV113[V206GLJ042];
		int V206DEV114[V206GLJ042];

		V206IOCTL161 V206DEV115[4];
		V206IOCTL159 V206DEV116[4];
		V206IOCTL172 V206DEV117[V206GLJ042];
		V206IOCTL173 V206DEV118[V206GLJ042];
		V206IOCTL168 V206DEV119[4];
		SaveMemMgr V206DEV120;
		int V206DEV121[6];
		struct {
#if 0
			unsigned int V206DEV122;
			unsigned int V206DEV123[1024];

			unsigned int V206DEV124;
			unsigned int V206DEV125[1024];
#endif
			unsigned int V206DEV126;
			unsigned int V206DEV127[16];
			unsigned int V206DEV128;
			unsigned int V206DEV129[712];
	...
	unsigned int V206DEV140[4] ;
	int V206DEV141[4];
	GLJ_LOCK  V206DEV142;
	V206IOCTL159 V206DEV143;
	V206IOCTL172 V206DEV144[V206GLJ042];
	int V206DEV145;
	...
	struct {
		unsigned int V206DEV157;
		unsigned int V206DEV158;
	} V206DEV159[4];
...
int FUNC206HAL136(V206DEV025 *pDev, enum V206IOCTL109 pllID, int freq);
