...
#include "../include/videoadd_reg.h"
...
static int FUNC206HAL039(void *devInfo, int index)
{
	...
	result = FUNC206HAL042(devInfo, index, MAC206HAL055, 0x270, 0x8);


	result = FUNC206HAL042(devInfo, index, MAC206HAL055, 0x274, 0x8);
